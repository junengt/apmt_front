                ...
                <Nav style={{alignItems: 'center'}} className="center navbar-nav">
                    ...
                    <ToggleButtonGroup type="checkbox" value={value} onChange={handleChange} onClick={()=>{navigate('/items')}}>
                        ...
                        <ToggleButton className=' bg-black border-0  align-self-center navbar-text' id="tbg-btn-1"
                                      value={'Mac'} style={buttonSize}>
                            <NavItem className="nav-item-box">
                                Mac
                            </NavItem>
                        </ToggleButton>
                        <ToggleButton className='bg-black border-0  align-self-center navbar-text' id="tbg-btn-2"
                        ...
                        <ToggleButton className='bg-black border-0  align-self-center navbar-text' id="tbg-btn-3"
                                      value={'Watch'} style={buttonSize}>
                            <NavItem className="nav-item-box">
                                Watch
                            </NavItem>

                        </ToggleButton>
                        <ToggleButton className='bg-black border-0  align-self-center navbar-text' id="tbg-btn-4"
                                      value={'iPhone'} style={buttonSize}>
                            <NavItem className="nav-item-box">
                                iPhone
                            </NavItem>

                        </ToggleButton>
                        <ToggleButton className='bg-black border-0  align-self-center navbar-text' id="tbg-btn-5"
                                      value={'AirPods'} style={buttonSize}>
                            <NavItem className="nav-item-box">
                                AirPods
                            </NavItem>
