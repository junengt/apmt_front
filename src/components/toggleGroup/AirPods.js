        ...
        <>
            <Nav style={{alignItems: 'center'}}
                ...
                <ToggleButtonGroup className='chpater-items' type="checkbox"
                    ...
                    <ToggleButton className={buttonClassName} id="tbg-btn-5"
                                  value={'AirPods'} style={{
                        fontSize: '20px',
                        margin: '25px auto',
                        border: 'none',
                        ...
                        <NavItem className="">
                            <p className="">AirPods<i className="fa-solid fa-angle-right"></i> </p>
                        </NavItem>
                    </ToggleButton>
                    <ToggleButton className={buttonClassName} id="tbg-airpodsBtn-1"
                                  value={'AirPods Series'} style={buttonSize}>
                        <NavItem className="">
                    ...
                    <ToggleButton className={buttonClassName} id="tbg-airpodsBtn-2"
                                  value={'AirPods Pro'} style={buttonSize}>
                        <NavItem className="">
                            <img
                    ...
                    <ToggleButton className={buttonClassName} id="tbg-airpodsBtn-3"
                    ...
                    <ToggleButton className={buttonClassName} id="tbg-airpodsBtn-4"
                                  value={''} style={buttonSize}>
                        <NavItem className="">

                        </NavItem>
                    </ToggleButton>
                    <ToggleButton className={buttonClassName} id="tbg-airpodsBtn-5"
                                  value={''} style={buttonSize}>
