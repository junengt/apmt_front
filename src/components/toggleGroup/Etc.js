        ...
        <>
            <Nav style={{alignItems: 'center'}}
                ...
                <ToggleButtonGroup className='chpater-items' type="checkbox"
                    ...
                    <ToggleButton className={buttonClassName} id="tbg-btn-6"
                                  value={'Etc.'} style={{
                        fontSize: '20px',
                        margin: '25px auto',
                        border: 'none',
                        ...
                        <NavItem className="">
                            <p className="">Etc.<i className="fa-solid fa-angle-right"></i> </p>
                        </NavItem>
                    </ToggleButton>
                    <ToggleButton className={buttonClassName} id="tbg-etcBtn-1"
                                  value={'Display'} style={buttonSize}>
                        <NavItem className="">
                    ...
                    <ToggleButton className={buttonClassName} id="tbg-etcBtn-2"
                                  value={'AirTag'} style={buttonSize}>
                        <NavItem className="">
                            <img
                    ...
                    <ToggleButton className={buttonClassName} id="tbg-etcBtn-3"
                                  value={'Mac mini'} style={buttonSize}>
                        <NavItem className="">
                            <img
                                className="chapter-icon chapternav-item-macbook-pro-13"
                    ...
                    <ToggleButton className={buttonClassName} id="tbg-etcBtn-4"
                                  value={'Mac Studio'} style={buttonSize}>
                        <NavItem className="">
                            <img
                                className="chapter-icon chapternav-item-macbook-pro-13"
                    ...
                    <ToggleButton className={buttonClassName} id="tbg-etcBtn-5"
                                  value={'Mac Pro'} style={buttonSize}>
                        <NavItem className="">
                            <img
                                className="chapter-icon chapternav-item-macbook-pro-13"
