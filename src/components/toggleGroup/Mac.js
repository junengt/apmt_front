        ...
        <>
            <Nav style={{alignItems: 'center'}}
                ...
                <ToggleButtonGroup className='chpater-items' type="checkbox"
                    ...
                    <ToggleButton className={buttonClassName} id="tbg-btn-1"
                                  value={'Mac'} style={{
                        fontSize: '20px',
                        margin: '25px auto',
                        border: 'none',
                        ...
                        <NavItem className="">
                            <p className="">Mac <i className="fa-solid fa-angle-right"></i> </p>
                        </NavItem>
                    </ToggleButton>
                    <ToggleButton className={buttonClassName} id="tbg-macBtn-1"
                                  value={'MacBook Air'} style={buttonSize}>
                        <NavItem className="">
                    ...
                    <ToggleButton className={buttonClassName} id="tbg-macBtn-2"
                                  value={'MacBook Pro'} style={buttonSize}>
                        <NavItem className="">
                            <img className="chapter-icon"
                    ...
                    <ToggleButton className={buttonClassName} id="tbg-macBtn-3"
                                  value={'iMac 24"'} style={buttonSize}>
                        <NavItem className="">
                            <img className="chapter-icon chapternav-item-imac-24"
                    ...
                    <ToggleButton className={buttonClassName} id="tbg-macBtn-4"
                    ...
                    <ToggleButton className={buttonClassName} id="tbg-macBtn-5"
